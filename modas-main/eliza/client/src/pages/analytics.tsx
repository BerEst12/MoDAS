...
const protocolData = [
    { id: 'desyn', name: 'DeSyn Protocol', value: 229.12 },
    { id: 'unibtc', name: 'uniBTC Restaked', value: 95.98 },
    { id: 'ionic', name: 'Ionic Protocol', value: 80.08 },
    { id: 'balancer', name: 'Balancer V2', value: 29.56 },
    { id: 'velodrome', name: 'Velodrome', value: 9.94 }
];
    ...
    return (
        <div className="h-full flex flex-col p-6 overflow-auto">
            <div className="flex items-center justify-between mb-6">
                <h1 className="text-2xl font-semibold">Mode DeFi Ecosystem Analytics</h1>
