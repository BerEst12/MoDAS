        ...
        <div className="min-h-screen flex flex-col bg-background">
                ...
                <div className="container flex h-14 items-center justify-between">
                    <div className="flex items-center gap-8">
                        <a href="/" className="flex items-center gap-2 text-lg font-semibold">
                            <img src={logo} alt="MoDAS Logo" className="h-6 w-6" />
                            <span className="bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">MoDAS</span>
                        </a>
                    ...
                    <Button onClick={() => navigate('/app/chat/default')} className="bg-brand-yellow text-black hover:bg-brand-yellow/90 flex items-center gap-2">
            ...
            <main className="flex-1">
                ...
                <section id="home" className="container py-24">
                    <div className="flex flex-col items-center text-center">
                        <div className="flex items-center justify-center mb-8">
                            <img src={hero} alt="MoDAS Hero" className="w-80 h-80" />
                        </div>
                        <div className="space-y-8">
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent" style={{ lineHeight: '1.2' }}>
                                Revolutionizing DeFi with AI-Powered Agent Swarms on Mode Network
                            </h1>
                            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
                                Simplify your DeFi experience with the power of Multi-Agent Systems (MAS) on Mode Network
                            </p>
                            <div className="flex items-center gap-4 justify-center">
                                <Button size="lg" onClick={() => navigate('/app/chat/default')} className="bg-brand-yellow text-black hover:bg-brand-yellow/90 flex items-center gap-2">
                ...
                <section id="features" className="py-24 bg-background-secondary">
                    <div className="container space-y-12">
                        <div className="text-center space-y-4">
                            <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">Why Multi-Agent Systems?</h2>
                                    ...
                                    >
                                        <Card className="bg-background border-white/[0.08] hover:bg-background-secondary transition-colors h-full">
                                            <div className="p-6 flex flex-col items-center text-center space-y-6">
                                                <div className="h-16 w-16 rounded-2xl bg-brand-yellow/10 text-brand-yellow flex items-center justify-center group-hover:scale-110 transition-transform ring-1 ring-white/10">
                                                    <Icon className="h-8 w-8" />
                                                </div>
                                                <div className="space-y-3">
                                                    <h3 className="text-xl font-semibold group-hover:text-brand-yellow transition-colors">{feature.title}</h3>
                ...
                <section className="py-24 bg-background">
                    <div className="container space-y-12">
                        <div className="text-center space-y-4">
                            <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">Our Architecture</h2>
                            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl">
                            <Card className="bg-background border-white/[0.08]">
                                <CardHeader>
                                    <CardTitle className="text-brand-yellow">User Interface</CardTitle>
                                    <CardDescription>
                            ...
                            <Card className="bg-background border-white/[0.08]">
                                <CardHeader>
                                    <CardTitle className="text-brand-yellow">Coordinator Agent</CardTitle>
                                    <CardDescription>
                            ...
                            <Card className="bg-background border-white/[0.08]">
                                <CardHeader>
                                    <CardTitle className="text-brand-yellow">Specialized Agents</CardTitle>
                                    <CardDescription>
                        ...
                        <div className="flex flex-col items-center space-y-8">
                            <div className="w-full max-w-5xl bg-background rounded-lg p-8 border border-white/[0.08]">
                                <img
                                    ...
                                    alt="MoDAS Architecture Diagram"
                ...
                <section id="pricing" className="container py-24 space-y-12">
                    <div className="text-center space-y-4">
                        <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">Flexible Plans for Every User</h2>
                    </div>
                        ...
                        {[
                            {
                                ...
                                href: "https://t.me/MoDASSalesAgent_bot"
                            },
                            {
                                title: "Pro Tier",
                                price: "$19.99",
                            ...
                            <Card key={index} className={`bg-background border-white/[0.08] hover:bg-background-secondary transition-colors ${plan.featured ? 'ring-2 ring-brand-yellow' : ''}`}>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <Button
                                        className={`w-full ${plan.featured ? 'bg-brand-yellow text-black hover:bg-brand-yellow/90' : 'border-white/10 hover:bg-white/5'}`}
                ...
                <section id="contact" className="py-24 bg-background-secondary">
                    <div className="container space-y-12">
                        <div className="text-center space-y-4">
                            <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">Talk to Our AI Sales Agent</h2>
                            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                        ...
                        <div className="flex justify-center">
                            <a href="https://t.me/MoDASSalesAgent_bot" target="_blank" rel="noopener noreferrer">
                ...
                <section className="container py-24 space-y-12">
                    <div className="text-center space-y-4">
                        <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">Stay Updated with Our Meme Agent</h2>
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                    ...
                    <div className="flex justify-center gap-8">
                        <a href="https://x.com/MoDasAgent" target="_blank" rel="noopener noreferrer" className="group">
                ...
                <section id="opensource" className="py-24 bg-background-secondary">
                    <div className="container space-y-12">
                        <div className="text-center space-y-4">
                            <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">Open Source and Built for Collaboration</h2>
                            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                                Mode DeFi Agent Swarm is an open-source initiative. We invite developers and contributors to help us expand the MAS ecosystem and redefine DeFi automation together.
                            </p>
                        </div>
                        <div className="flex justify-center gap-4">
                            <Button variant="outline" size="lg" className="border-white/10 hover:bg-white/5" onClick={() => window.location.href = 'https://github.com/worksgoodcompany/modas'}>
                                <img src={githubIcon} alt="GitHub" className="mr-2 h-4 w-4" />
                                Contribute on GitHub
                            </Button>
                            <Button variant="outline" size="lg" className="border-white/10 hover:bg-white/5" onClick={() => window.location.href = 'https://discord.gg/mmJJtGpkqy'}>
            ...
            <footer className="border-t border-white/[0.08] bg-background">
                <div className="container py-12">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        <div className="space-y-4">
                            <div className="flex flex-col items-center text-center">
                                <div className="flex items-center gap-2">
                                    <img src={logo} alt="MoDAS Logo" className="h-6 w-6" />
                                    <h3 className="text-lg font-semibold bg-gradient-to-r from-brand-yellow to-brand-green bg-clip-text text-transparent">MoDAS</h3>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col items-center gap-4 mt-4">
                                <a
                                    href="https://t.me/MoDASCoordinatorAgent_bot"
                                ...
                                <a
                                    href="https://github.com/worksgoodcompany/sodas-aiws"
                                    className="w-6 h-6 flex items-center justify-center"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                    ...
                    <div className="mt-12 pt-8 border-t border-white/[0.08] text-center text-sm text-muted-foreground">
                        © 2024 Mode DeFi Agent Swarm. All rights reserved.
                    </div>
                </div>
            </footer>
        </div>
